'use client'
import styles from "./EnterUser.module.css";
            ...
            <div className={styles.authorization}>
                ...
                <div className={styles.buttons}>
                    <button
                        ...
                        className={styles.enter}>Войти</button>
                    <Link href="/registration">
                        <button className={styles.regestration}>Регистрация</button>
                    </Link>
                </div>
                <Link className={styles.forgot} href='/forgot'>Забыли пароль?</Link>
